...
// link mass
const TYPE mass[NUM_JOINTS] = { 1.3773, 1.1636, 1.1636, 0.9302, 0.6781, 0.6781, 0.5, 0.60831, 0.04394, 0.1715}; // note: this does not include the base link
...
// meter
const TYPE link_radius[NUM_FACTORS][3] = {{0.070, 0.070, 0.070}, 
									      {0.070, 0.070, 0.070}, 
										  {0.070, 0.070, 0.070}, 
										  {0.070, 0.070, 0.070}, 
									      {0.070, 0.070, 0.070}, 
