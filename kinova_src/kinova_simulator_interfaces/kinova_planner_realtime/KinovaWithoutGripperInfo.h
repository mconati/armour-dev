...
const double mass_uncertainty[NUM_JOINTS] = {0.03, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03};
...
const double inertia_uncertainty[NUM_JOINTS] = {0.03, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03};
