...
// link mass
const double mass[NUM_JOINTS] = { 1.3773, 1.1636, 1.1636, 0.9302, 0.6781, 0.6781, 1.15225, 0.1715 }; // the end effector is a 0.1715 kg cube
const double mass_uncertainty[NUM_JOINTS] = { 0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.5};
...
const double inertia[NUM_JOINTS * 9] = {  0.00457, 0.000001, 0.000002, 0.000001, 0.004831, 0.000448, 0.000002, 0.000448, 0.001409,
										...
										0.00397368, -3.1457e-7, -6.03666e-7, -3.1457e-7, 0.00310542, -0.000378758, -6.03666e-7, -0.000378758, 0.00167837,
										0.00007385, 0, 0, 0, 0.00007385, 0, 0, 0, 0.00007385 };
const double inertia_uncertainty[NUM_JOINTS] = { 0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.5};
