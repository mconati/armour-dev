...
%% automated from here
robust_out_armour_final = zeros(A.n_inputs, 100);
robust_out_althoff_final = zeros(A.n_inputs, 100);
...
for sam = 1:100
    ...
    %% trajectory params
    traj_q0 = pi * rand(A.n_inputs, 1) - pi / 2;
    traj_qd0 = pi * rand(A.n_inputs, 1) - pi / 2;
    traj_qdd0 = pi * rand(A.n_inputs, 1) - pi / 2;
    T = 2.5;
...
save(['robust_input_', num2str(100 * model_uncertainty), '.mat'], 'robust_out_armour_final', 'robust_out_althoff_final');
