...
model_uncertainties = [0, 0.03, 0.05, 0.1, 0.25, 0.5];
...
%% robot params:
    ...
    for sam = 1:100
        ...
        %% trajectory params
        q_diff = rand(A.n_inputs, 1) * 2 - 1; q_diff = pi * q_diff / norm(q_diff);
        qd_diff = rand(A.n_inputs, 1) * 2 - 1; qd_diff = 2 * pi * qd_diff / norm(qd_diff);
        traj_q0 = q0 + q_diff;
