function [Q_des, Qd_des, Qdd_des, Q, Qd, Qd_a, Qdd_a, R_des, R_t_des, R, R_t, T, E_p, jrs_info] = create_jrs_online_modified(q, dq, ddq, joint_axes, taylor_degree, traj_type, add_ultimate_bound, LLC_info)
% patrick 20220330
